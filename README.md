...
**v1.1.14 "Regalia"** | **FREE AND OPEN SOURCE** | **GPL v2**
...
- **v1.1.14:** The classic Main Street layout is a setting (Settings, key S), with a tip on the district menu. Every online pause keeps a typed command. Engulf skips a held target, goblins crit once per fight, and the alt slot opens at level 25. Every way onto a team keeps the five-member limit, and the royal court, quests, NPC gear and admin tools fix the remaining known issues from 1.1.13. See `DOCS/release-notes/RELEASE_NOTES_1.1.14.md`.
...
**Status:** v1.1.14 "Regalia". The world is running. [Watch it live.](https://usurper-reborn.net)
